...
const DoctorForm = () => {
    ...
    const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (checked) {
            setFormData({ 
                ...formData, 
                [name]: [...(formData[name as keyof DoctorFormData] as string[]), value] 
            });
        } else {
            setFormData({
                ...formData,
                [name]: (formData[name as keyof DoctorFormData] as string[]).filter(item => item !== value)
            });
        }
    };
            ...
            <div className="sm:col-span-6">
              ...
              <div className="mt-2">
                <input
                  ...
                  name="facility"
                  type="text"
                  value={formData.facility.join(',')}
                  onChange={(e) => setFormData({...formData, facility: e.target.value.split(',')})}
